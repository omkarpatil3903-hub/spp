...
const resources = {
  en: {
    translation: {
      ...
      "home.specialtiesText":
        "Committed to serving our community with dedication and vision.",
      "about.title": "About {{businessName}}",
      "about.description":
        "We are passionate about delivering high-quality solutions and fostering strong relationships with our clients.",
      ...
      "specialties.description":
        "We are committed to driving progress and serving our community.",
      "specialties.noSpecialties": "No agenda items to display yet.",
      "bestEmployee.title": "Our Vision",
      "bestEmployee.description":
        "Meet the dedicated individuals working towards our shared vision.",
      ...
      "contact.form.error.mobile":
        "Error: Invalid or missing mobile number. Cannot submit inquiry.",
      ...
      "error.message": "{{error}}",
      "error.hint":
        "Please ensure your data is correctly structured in Realtime Database under: <br /><span class='code-path'>{{path}}</span>",
      "noData.title": "No Data Found",
      "noData.message":
        "No website data available for mobile number: <span class='highlight-text-yellow-dark'>{{mobile}}</span>.",
      "noData.hint":
        "Please ensure you have uploaded your business information to Realtime Database at: <br /><span class='code-path'>{{path}}</span>",
    },
  },
  hi: {
    translation: {
      ...
      "home.discover":
        "हमारी सेवाओं की खोज करें और देखें कि हमें क्या अद्वितीय बनाता है।",
      "home.products": "ताज़ा बातम्या",
      "home.productsText": "हमारी नवीनतम घोषणाओं और पहल से अपडेट रहें।",
      "home.specialties": "हमारी कार्यसूची",
      "home.specialtiesText":
        "समर्पण और दृष्टि के साथ हमारे समुदाय की सेवा के लिए प्रतिबद्ध।",
      "about.title": "{{businessName}} के बारे में",
      "about.description":
        "हम उच्च गुणवत्ता वाले समाधान प्रदान करने और अपने ग्राहकों के साथ मजबूत संबंध बनाने के लिए उत्साहित हैं।",
      "about.noTeam": "अभी कोई टीम सदस्य प्रदर्शित करने के लिए नहीं हैं।",
      "products.title": "ताज़ा बातम्या",
      "products.description":
        "हमारी नवीनतम अपडेट्स और घोषणाओं के बारे में जानकारी प्राप्त करें।",
      ...
      "specialties.description":
        "हम प्रगति और अपने समुदाय की सेवा के लिए प्रतिबद्ध हैं।",
      "specialties.noSpecialties":
        "अभी कोई कार्यसूची आइटम प्रदर्शित करने के लिए नहीं हैं।",
      "bestEmployee.title": "हमारी दृष्टि",
      "bestEmployee.description":
        "हमारी साझी दृष्टि के लिए काम करने वाले समर्पित व्यक्तियों से मिलें।",
      "bestEmployee.noEmployees":
        "अभी कोई टीम सदस्य प्रदर्शित करने के लिए नहीं हैं।",
      "gallery.title": "हमारी गैलरी",
      "contact.title": "संपर्क करें",
      "contact.description":
        "हम आपसे सुनना चाहेंगे! निम्नलिखित किसी भी माध्यम से हमसे संपर्क करें।",
      ...
      "contact.form.error.mobile":
        "त्रुटि: अमान्य या अनुपस्थित मोबाइल नंबर। पूछताछ जमा नहीं की जा सकती।",
      ...
      "error.message": "{{error}}",
      "error.hint":
        "कृपया सुनिश्चित करें कि आपका डेटा रियलटाइम डेटाबेस में सही ढंग से संरचित है: <br /><span class='code-path'>{{path}}</span>",
      "noData.title": "कोई डेटा नहीं मिला",
      "noData.message":
        "मोबाइल नंबर के लिए कोई वेबसाइट डेटा उपलब्ध नहीं: <span class='highlight-text-yellow-dark'>{{mobile}}</span>।",
      "noData.hint":
        "कृपया सुनिश्चित करें कि आपने रियलटाइम डेटाबेस में अपनी व्यावसायिक जानकारी अपलोड की है: <br /><span class='code-path'>{{path}}</span>",
    },
  },
  mr: {
    translation: {
      ...
      "home.discover":
        "आमच्या सेवांचा शोध घ्या आणि आम्हाला काय अद्वितीय बनवते ते पहा.",
      "home.products": "ताज्या बातम्या",
      "home.productsText":
        "आमच्या नवीनतम घोषणा आणि उपक्रमांबद्दल अद्ययावत रहा.",
      "home.specialties": "आमची कार्यसूची",
      "home.specialtiesText":
        "समर्पण आणि दृष्टीकोनासह आमच्या समुदायाची सेवा करण्यास वचनबद्ध.",
      "about.title": "{{businessName}} बद्दल",
      "about.description":
        "आम्ही उच्च दर्जाचे उपाय प्रदान करण्यासाठी आणि आमच्या ग्राहकांशी मजबूत संबंध निर्माण करण्यासाठी उत्साही आहोत.",
      "about.noTeam": "अद्याप प्रदर्शित करण्यासाठी कोणतेही संघ सदस्य नाहीत.",
      "products.title": "चालू घडामोडी",
      "products.description":
        "आमच्या नवीनतम अपडेट्स आणि घोषणांबद्दल माहिती मिळवा.",
      "products.noProducts":
        "अद्याप प्रदर्शित करण्यासाठी कोणत्याही बातम्या नाहीत.",
      "products.viewDetails": "अधिक वाचा",
      "specialties.title": "आमची कार्यसूची",
      "specialties.description":
        "आम्ही प्रगती आणि आमच्या समुदायाची सेवा करण्यास वचनबद्ध आहोत.",
      "specialties.noSpecialties":
        "अद्याप प्रदर्शित करण्यासाठी कोणत्याही कार्यसूची आयटम नाहीत.",
      "bestEmployee.title": "आमची दृष्टी",
      "bestEmployee.description":
        "आमच्या समान दृष्टीकोनासाठी कार्यरत समर्पित व्यक्तींना भेटा.",
      "bestEmployee.noEmployees":
        "अद्याप प्रदर्शित करण्यासाठी कोणतेही टीम सदस्य नाहीत.",
      "gallery.title": "आमची गॅलरी",
      "contact.title": "संपर्क साधा",
      "contact.description":
        "आम्हाला तुमच्याकडून ऐकायला आवडेल! खालील कोणत्याही माध्यमातून आमच्याशी संपर्क साधा.",
      ...
      "contact.form.error.mobile":
        "त्रुटी: अवैध किंवा गहाळ मोबाइल नंबर. चौकशी सबमिट करू शकत नाही.",
      ...
      "error.message": "{{error}}",
      "error.hint":
        "कृपया खात्री करा की तुमचा डेटा रियलटाइम डेटाबेसमध्ये योग्यरित्या संरचित आहे: <br /><span class='code-path'>{{path}}</span>",
      "noData.title": "कोणताही डेटा सापडला नाही",
      "noData.message":
        "मोबाइल नंबरसाठी कोणताही वेबसाइट डेटा उपलब्ध नाही: <span class='highlight-text-yellow-dark'>{{mobile}}</span>.",
      "noData.hint":
        "कृपया खात्री करा की तुम्ही रियलटाइम डेटाबेसमध्ये तुमची व्यावसायिक माहिती अपलोड केली आहे: <br /><span class='code-path'>{{path}}</span>",
    },
  },
  kn: {
    translation: {
      ...
      "home.discover":
        "ನಮ್ಮ ಸೇವೆಗಳನ್ನು ಅನ್ವೇಷಿಸಿ ಮತ್ತು ನಮ್ಮನ್ನು ವಿಶಿಷ್ಟವಾಗಿಸುವುದನ್ನು ನೋಡಿ.",
      "home.products": "ನಮ್ಮ ಉತ್ಪನ್ನಗಳು",
      "home.productsText":
        "ನಿಮ್ಮ ಅಗತ್ಯಗಳನ್ನು ಪೂರೈಸಲು ಮತ್ತು ನಿಮ್ಮ ನಿರೀಕ್ಷೆಗಳನ್ನು ಮೀರಿಸಲು ವಿನ್ಯಾಸಗೊಳಿಸಲಾದ ನಮ್ಮ ಅತ್ಯಾಧುನಿಕ ಉತ್ಪನ್ನಗಳನ್ನು ಅನ್ವೇಷಿಸಿ.",
      "home.specialties": "ನಮ್ಮ ವಿಶೇಷತೆಗಳು",
      "home.specialtiesText":
        "ನಾವು ಉನ್ನತ ಗುಣಮಟ್ಟದ ಸೇವೆಗಳನ್ನು ಒದಗಿಸುವಲ್ಲಿ ಪರಿಣತರಾಗಿದ್ದೇವೆ.",
      "about.title": "{{businessName}} ಬಗ್ಗೆ",
      "about.description":
        "ನಾವು ಉನ್ನತ ಗುಣಮಟ್ಟದ ಪರಿಹಾರಗಳನ್ನು ಒದಗಿಸಲು ಮತ್ತು ನಮ್ಮ ಗ್ರಾಹಕರೊಂದಿಗೆ ಬಲವಾದ ಸಂಬಂಧಗಳನ್ನು ಬೆಳೆಸಲು ಉತ್ಸುಕರಾಗಿದ್ದೇವೆ.",
      "about.noTeam": "ಪ್ರದರ್ಶಿಸಲು ಇನ್ನೂ ಯಾವುದೇ ತಂಡದ ಸದಸ್ಯರಿಲ್ಲ.",
      "products.title": "ನಮ್ಮ ಉತ್ಪನ್ನಗಳು",
      "products.description":
        "ನಿಮ್ಮ ಅನುಭವವನ್ನು ಹೆಚ್ಚಿಸಲು ಮತ್ತು ಅಸಾಧಾರಣ ಮೌಲ್ಯವನ್ನು ಒದಗಿಸಲು ವಿನ್ಯಾಸಗೊಳಿಸಲಾದ ನಮ್ಮ ವೈವಿಧ್ಯಮಯ ಉತ್ಪನ್ನಗಳ ಶ್ರೇಣಿಯನ್ನು ಅನ್ವೇಷಿಸಿ.",
      ...
      "specialties.description":
        "ನಮ್ಮ ಮೂಲ ಸಾಮರ್ಥ್ಯಗಳು ಮತ್ತು ನಮ್ಮ ಗ್ರಾಹಕರಿಗೆ ನೀಡುವ ವಿಶೇಷ ಸೇವೆಗಳ ಬಗ್ಗೆ ನಾವು ಹೆಮ್ಮೆಪಡುತ್ತೇವೆ.",
      "specialties.noSpecialties": "ಪ್ರದರ್ಶಿಸಲು ಇನ್ನೂ ಯಾವುದೇ ವಿಶೇಷತೆಗಳಿಲ್ಲ.",
      "bestEmployee.title": "ನಮ್ಮ ದೃಷ್ಟಿಭಂಗಿ",
      "bestEmployee.description":
        "ನಾವು ನಮ್ಮ ಶ್ರೇಷ್ಠ ಉದ್ಯೋಗಿಗಳ ಅಸಾಧಾರಣ ಕೊಡುಗೆಯನ್ನು ಗುರುತಿಸುತ್ತೇವೆ ಮತ್ತು ಗೌರವಿಸುತ್ತೇವೆ. ಅವರ ಸಮರ್ಪಣೆ ನಮ್ಮ ಯಶಸ್ಸನ್ನು ಚಾಲನೆ ಮಾಡುತ್ತದೆ.",
      "bestEmployee.noEmployees":
        "ಪ್ರದರ್ಶಿಸಲು ಇನ್ನೂ ಯಾವುದೇ ಶ್ರೇಷ್ಠ ಉದ್ಯೋಗಿ ಪ್ರಶಸ್ತಿಗಳಿಲ್ಲ.",
      "gallery.title": "ನಮ್ಮ ಗ್ಯಾಲರಿ",
      "contact.title": "ಸಂಪರ್ಕಿಸಿ",
      "contact.description":
        "ನಾವು ನಿಮ್ಮಿಂದ ಕೇಳಲು ಇಷ್ಟಪಡುತ್ತೇವೆ! ಈ ಕೆಳಗಿನ ಯಾವುದೇ ಚಾನಲ್‌ಗಳ ಮೂಲಕ ನಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸಿ.",
      ...
      "contact.form.error.mobile":
        "ದೋಷ: ಅಮಾನ್ಯ ಅಥವಾ ಕಾಣೆಯಾದ ಮೊಬೈಲ್ ಸಂಖ್ಯೆ. ವಿಚಾರಣೆಯನ್ನು ಸಲ್ಲಿಸಲಾಗದು.",
      "contact.form.success": "ವಿಚಾರಣೆಯನ್ನು ಯಶಸ್ವಿಯಾಗಿ ಸಲ್ಲಿಸಲಾಗಿದೆ!",
      "contact.form.error.submit":
        "ವಿಚಾರಣೆಯನ್ನು ಸಲ್ಲಿಸಲು ವಿಫಲವಾಗಿದೆ: {{error}}",
      "contact.hours": "ಗಂಟೆಗಳು: {{timings}}",
      "contact.whatsapp": "ವಾಟ್ಸಾಪ್‌ನಲ್ಲಿ ಚಾಟ್ ಮಾಡಿ",
      "contact.share": "ಹಂಚಿಕೊಳ್ಳಿ",
      "footer.text":
        "© {{year}} {{businessName}}. ಎಲ್ಲಾ ಹಕ್ಕುಗಳನ್ನು ಕಾಯ್ದಿರಿಸಲಾಗಿದೆ.",
      "footer.designed":
        "❤️ ಜೊತೆಗೆ ವಿನ್ಯಾಸಗೊಳಿಸಲಾಗಿದೆ ಮತ್ತು ಅಭಿವೃದ್ಧಿಪಡಿಸಲಾಗಿದೆ",
      "loading.text": "ವೆಬ್‌ಸೈಟ್ ಡೇಟಾವನ್ನು ಲೋಡ್ ಮಾಡಲಾಗುತ್ತಿದೆ...",
      "error.title": "ದೋಷ!",
      "error.message": "{{error}}",
      "error.hint":
        "ದಯವಿಟ್ಟು ನಿಮ್ಮ ಡೇಟಾವನ್ನು ರಿಯಲ್‌ಟೈಮ್ ಡೇಟಾಬೇಸ್‌ನಲ್ಲಿ ಸರಿಯಾಗಿ ರಚನೆಗೊಳಿಸಲಾಗಿದೆ ಎಂದು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ: <br /><span class='code-path'>{{path}}</span>",
      "noData.title": "ಯಾವುದೇ ಡೇಟಾವಿಲ್ಲ",
      "noData.message":
        "ಮೊಬೈಲ್ ಸಂಖ್ಯೆಗೆ ಯಾವುದೇ ವೆಬ್‌ಸೈಟ್ ಡೇಟಾವಿಲ್ಲ: <span class='highlight-text-yellow-dark'>{{mobile}}</span>.",
      "noData.hint":
        "ದಯವಿಟ್ಟು ನೀವು ರಿಯಲ್‌ಟೈಮ್ ಡೇಟಾಬೇಸ್‌ನಲ್ಲಿ ನಿಮ್ಮ ವ್ಯಾಪಾರ ಮಾಹಿತಿಯನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿದ್ದೀರಿ ಎಂದು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ: <br /><span class='code-path'>{{path}}</span>",
    },
  },
};
...
const AboutUsIcon = () => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H2v-2a3 3 0 015.356-1.857M17 20v-9a2 2 0 00-2-2h-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v9m14 0a6 6 0 00-6-6v6m6-3h-6"
    ></path>
  </svg>
);
const ProductsIcon = () => (
...
const SpecialtiesIcon = () => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M9 3v2m6-2v2M9 19v2m6-2v2M5 7h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-2M9 12H7m8-2v2m-8 2h2m6 0h2"
    ></path>
  </svg>
);
const GalleryIcon = () => (
    ...
    <div className="page-container bg-gradient-purple-indigo">
      <div className="content-card">
        ...
        <div id="home">
                ...
                {contactInfo?.phone && (
                  ...
                  >
                    ...
                    <a
                      ...
                      className="profile-info-text profile-link"
                    >
                      {contactInfo.phone}
                    </a>
                  </div>
                  ...
                  >
                    {contactInfo.instagram && (
                      ...
                      >
                        <svg fill="currentColor" viewBox="0 0 24 24">
                          <path d="M12.315 2c2.43 0 2.792.01 3.24.029 2.863.186 4.464 1.42 5.256 2.21.79.791 2.024 2.393 2.21 5.257.019.447.029.81.029 3.24s-.01 2.793-.029 3.24c-.186 2.863-1.42 4.464-2.21 5.256-.791.79-2.393 2.024-5.257 2.21-.447.019-.81.029-3.24.029s-2.793-.01-3.24-.029c-2.863-.186-4.464-1.42-5.256-2.21-.79-.791-2.024-2.393-2.21-5.257-.019-.447-.029-.81-.029-3.24s.01-2.793.029-3.24c.186-2.863 1.42-4.464 2.21-5.256.791-.79 2.393-2.024 5.257-2.21.447-.019.81-.029 3.24-.029zm0 2.163c-2.899 0-3.21.011-3.657.031-2.613.17-4.14 1.34-4.845 2.046-.705.705-1.876 2.232-2.046 4.845-.02.447-.031.758-.031 3.657s.011 3.21.031 3.657c.17 2.613 1.34 4.14 2.046 4.845.705.705 2.232 1.876 4.845 2.046.447.02.758.031 3.657.031s3.21-.011 3.657-.031c2.613-.17 4.14-1.34 4.845-2.046.705-.705 1.876-2.232 2.046-4.845.02-.447.031-.758.031-3.657s-.011-3.21-.031-3.657c-.17-2.613-1.34-4.14-2.046-4.845-.705-.705-2.232-1.876-4.845-2.046-.447-.02-.758-.031-3.657-.031zM12.315 9.176c1.554 0 2.81 1.256 2.81 2.81s-1.256 2.81-2.81 2.81-2.81-1.256-2.81-2.81 1.256-2.81 2.81-2.81zm0 2.163c-.381 0-.693.312-.693.693s.312.693.693.693.693-.312.693-.693-.312-.693-.693-.693zM16.5 7.404c-.655 0-1.185.53-1.185 1.185s.53 1.185 1.185 1.185 1.185-.53 1.185-1.185-.53-1.185-1.185-1.185z" />
                        </svg>
                      </a>
                    )}
                    {contactInfo.facebook && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="profile-social-icon facebook"
                      >
                        <svg fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {contactInfo.youtube && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="profile-social-icon youtube"
                      >
                        <svg fill="currentColor" viewBox="0 0 24 24">
                          <path d="M19.812 5.44C19.423 3.523 17.994 2.073 16.074 1.684 14.854 1.342 12 1.342 12 1.342s-2.854 0-4.074.342C5.994 2.073 4.564 3.523 4.176 5.44 3.834 6.66 3.834 9.342 3.834 9.342s0 2.682.342 3.9C4.564 15.462 5.994 16.912 7.914 17.302 9.134 17.644 12 17.644 12 17.644s2.854 0 4.074-.342c1.92-.39 3.349-1.84 3.738-3.758.342-1.218.342-3.9.342-3.9s0-2.682-.342-3.9zm-8.47 8.35v-6.98l6.103 3.49-6.103 3.49z" />
                        </svg>
                      </a>
                    )}
                    {contactInfo.whatsapp && (
          ...
          {/* Quick Info Cards */}
          <div
            className="grid-2-cols gap-8 mt-12"
            data-aos="fade-up"
            data-aos-delay="100"
          >
            <div className="card-item bg-gradient-blue-light">
              <h3
                ...
                data-aos-delay="100"
              >
                <ProductsIcon /> {t("home.products")}
              </h3>
              <p className="card-text">{t("home.productsText")}</p>
            </div>
            <div
              className="card-item bg-gradient-green-light"
              data-aos="fade-up"
              data-aos-delay="200"
            >
              <h3
                ...
                data-aos-delay="400"
              >
                <SpecialtiesIcon /> {t("home.specialties")}
              </h3>
...
const AboutUsPage = ({ data }) => {
  ...
  const aboutBusiness =
    data?.businessInfo?.AboutBusiness ||
    "A leading company committed to innovation and excellence.";
  useEffect(() => {
    AOS.init({
      duration: 1000,
      once: false,
      ...
      <div className="grid-3-cols sm-grid-2-cols gap-8">
        {teamMembers.length > 0 ? (
          teamMembers.map((member) => (
            <div
              key={member.id}
              className="team-member-card bg-gradient-indigo-purple"
            >
              <h3 className="team-member-name text-indigo-800">
                {member.name}
              </h3>
              <p className="team-member-position text-purple-600">
                {member.position}
              </p>
              {member.date && (
                <p className="team-member-date">
                  {t("about.date", {
...
const ProductsPage = ({ data }) => {
  ...
  return (
    <div data-aos="fade-up" data-aos-delay="200">
      ...
      <p className="sub-heading text-gray-700">{t("products.description")}</p>
      <div
        className="grid-3-cols sm-grid-2-cols gap-8"
        data-aos="fade-up"
        data-aos-delay="300"
      >
        {products.length > 0 ? (
          products.map((product) => (
            <div
              key={product.id}
              className="product-card bg-gradient-gray-light"
            >
              <div
              ...
              >
                <img
                  src={
                    product.imageUrl ||
                    "https://placehold.co/400x300/CCCCCC/333333?text=Product+Image"
                  }
                  alt={product.name}
...
const SpecialtiesPage = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      <p
        className="sub-heading text-gray-700"
        data-aos="fade-up"
        data-aos-delay="300"
      >
      ...
      <div
        className="grid-3-cols md-grid-2-cols gap-8"
        data-aos="fade-up"
        data-aos-delay="400"
      >
        {specialties.length > 0 ? (
          specialties.map((specialty, index) => (
            <div
              key={index}
              className="specialty-item bg-gradient-teal-blue"
              data-aos="zoom-in"
              data-aos-delay="500"
            >
              <div className="specialty-icon-container">✓</div>
...
const BestEmployeePage = ({ data }) => {
  ...
  return (
    <div>
      ...
      <div
        className="grid-3-cols sm-grid-2-cols"
        data-aos="fade-up"
        data-aos-delay="300"
      >
        {bestEmployees.length > 0 ? (
          bestEmployees.map((employee, index) => (
            <div key={index} className="product-card bg-gradient-gray-light">
              <div
                className="image-hover-container"
                onClick={() => setSelectedImage(employee.imageUrl)}
              >
                <img
                  src={
                    employee.imageUrl ||
                    "https://placehold.co/400x300/CCCCCC/333333?text=Team+Member"
                  }
              ...
              <div className="product-details">
                <h3 className="product-name text-gray-800">
...
const Gallery = ({ data }) => {
  ...
  return (
    <div>
      <h1
        className="main-heading highlight-text-blue text-purple-800"
        data-aos="fade-up"
        data-aos-delay="300"
      >
        {t("gallery.title")}
          ...
          images.map((image, index) => (
            ...
            >
              <img
                src={
                  image.imageUrl ||
                  "https://placehold.co/180x180/FDD835/616161?text=Gallery"
                }
...
const ContactUsPage = ({ data }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const inquiriesRef = ref(
        db,
        `MarketingPro/WebBuilder/${cleanMobile}/Inquiries`
      );
  ...
  return (
    <div data-aos="fade-up" data-aos-delay="300">
      <h1 className="main-heading text-purple-800">{t("contact.title")}</h1>
      <p className="sub-heading text-gray-700">{t("contact.description")}</p>
      ...
      <div className="contact-grid-container grid-2-cols">
        ...
        <div className="contact-form-wrapper bg-white p-6 rounded-xl shadow-md border border-gray-100">
          ...
          <form
            className="inquiry-form flex flex-col gap-4"
        ...
        <div
          className="contact-info-wrapper flex flex-col h-full"
          style={{ height: "100%" }}
        >
          ...
          <div className="contact-details-card bg-gradient-blue-light text-gray-800 p-8 rounded-xl shadow-lg flex-1 flex flex-col justify-center h-full border border-blue-100">
            <h3 className="text-2xl font-bold mb-8 border-b border-blue-200 pb-4 text-blue-700 tracking-wide">
              Contact Information
            </h3>
            ...
            <div className="flex flex-col gap-6">
              {contactInfo?.address && (
                <div className="contact-item flex items-start gap-4 p-3 rounded-lg hover:bg-white/50 transition-all duration-300">
                  ...
                  <div>
                    <p className="font-bold text-sm uppercase tracking-wider text-blue-600 mb-1">
                      Our Location
                    </p>
              ...
              {contactInfo?.email && (
                <div className="contact-item flex items-center gap-4 p-3 rounded-lg hover:bg-white/50 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <a
                      href={`mailto:${contactInfo.email}`}
                      className="text-lg font-medium text-gray-800 hover:text-blue-600 transition-colors break-all"
                    >
                      {contactInfo.email}
                    </a>
                  </div>
            ...
            {(contactInfo?.facebook ||
              ...
              <div className="mt-10 pt-6 border-t border-blue-200">
                <p className="text-center font-bold mb-6 text-blue-700 tracking-wide uppercase text-sm">
                  Connect With Us
                </p>
                <div className="flex justify-center gap-4 flex-wrap">
                  {contactInfo.facebook && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-blue-600 text-white p-3 rounded-full hover:scale-110 hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-blue-500/50"
                    >
                      <svg
                        className="w-6 h-6"
                        fill="currentColor"
                  ...
                  {contactInfo.instagram && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-pink-600 text-white p-3 rounded-full hover:scale-110 hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-pink-500/50"
                    >
                      <svg
                        className="w-6 h-6"
                        fill="currentColor"
                  ...
                  {contactInfo.youtube && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-red-600 text-white p-3 rounded-full hover:scale-110 hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-red-500/50"
                    >
                      <svg
                        className="w-6 h-6"
                        fill="currentColor"
                  ...
                  {contactInfo.whatsapp && (
                    <a
                      href={`https://wa.me/?text=${encodeURIComponent(
                        t("contact.share") + " " + window.location.href
                      )}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-green-500 text-white p-3 rounded-full hover:scale-110 hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-green-500/50"
                    >
                      <svg
                        className="w-6 h-6"
                        fill="currentColor"
...
function App() {
  ...
  const isValidMobileNumber =
    trimmedMobileNumber && /^\d{10}$/.test(trimmedMobileNumber);
  const REALTIME_DB_PATH = isValidMobileNumber
    ? `MarketingPro/WebBuilder/${trimmedMobileNumber}`
    : null;
      ...
      const unsubscribeAuth = onAuthStateChanged(auth, async (user) => {
        if (user) {
          ...
          try {
            ...
            console.warn(
              `Authentication failed: ${e.message}. Proceeding with public data access.`
            );
  ...
  useEffect(() => {
    if (!mobileNumber) {
      setError(
        t("error.message", {
          error:
            "Missing mobile number in the URL. Ensure URL is like /9370329233.",
        })
      );
      setLoading(false);
      return;
    ...
    if (!isValidMobileNumber) {
      setError(
        t("error.message", {
          error: `Invalid mobile number: "${mobileNumber}". Must be exactly 10 digits.`,
        })
      );
      setLoading(false);
      return;
      ...
      const unsubscribeData = onValue(
        ...
        (snapshot) => {
          if (snapshot.exists()) {
            ...
            setError(
              t("error.message", {
                error: `No website data found for mobile number: ${trimmedMobileNumber}.`,
              })
            );
          }
          setLoading(false);
        ...
        (e) => {
          setError(
            t("error.message", { error: `Failed to load data: ${e.message}.` })
          );
          setLoading(false);
        }
      );
        ...
        <div className="error-container">
          ...
          <p
            ...
            dangerouslySetInnerHTML={{
              __html: t("error.hint", {
                path:
                  REALTIME_DB_PATH || "MarketingPro/WebBuilder/{mobileNumber}",
              }),
            }}
          ></p>
        </div>
  ...
  return (
    <div className="app-container">
      ...
      <div className="navbar-container">
        ...
        <div className="navbar-links-desktop">
          {[
            ...
            {
              key: "bestEmployee",
              icon: <BestEmployeeIcon />,
              label: t("nav.bestEmployee"),
            },
            {
              key: "contactUs",
              icon: <ContactIcon />,
      ...
      <main className="app-container-main">{renderPage()}</main>
        ...
        <div className="footer-container">
          <p>
            {t("footer.text", {
              ...
              businessName:
                websiteData?.businessInfo?.businessName || "Your Business Name",
            })}
          </p>
          <p style={{ marginTop: "0.5rem" }}>{t("footer.designed")}</p>
